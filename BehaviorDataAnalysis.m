...
if strcmp(StimulusType, 'ITD')
    ...
    %filePath = strcat('/Users/baoagudemu1/Desktop/Lab/PilotExperiment/DataAnalysis/Data/', subjID, '_behavior/', subjID);
elseif strcmp(StimulusType, 'FM')
    filePath = strcat('/media/agudemu/Storage/Data/Behavior/', subjID, '_behavior/', subjID, '_', LeftOrRight);
    %filePath = strcat('/Users/baoagudemu1/Desktop/Lab/PilotExperiment/DataAnalysis/Data/', subjID, '_behavior/', subjID, '_', LeftOrRight);
